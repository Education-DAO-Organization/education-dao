      ...
      <div className={styles.hero}>
        ...
        <div className={styles.content}>
          ...
          <p>
            ...
            education, focused on the blockchain and decentralization. We’re not
            just building a platform; we’re nurturing innovation, championing
            diversity, creating a reservoir of educational resources and
            rewarding the contributors who help to make this happen. Together,
            we’re shaping the future of the Web3 ecosystem. Join us in this
            revolution.
          </p>
          <a
