...
:::resource-list{title='Additional Reading'}

::resource{title='Oracles (Ethereum.org)' link='https://ethereum.org/en/developers/docs/oracles/' description='A great overview of oracles on Ethereum with demo code for Chainlink' type='article'}
::resource{title='Blockchain Oracle' link='https://en.wikipedia.org/wiki/Blockchain_oracle' description='A great overview of oracles on Ethereum with demo code for Chainlink' type='article'}
::resource{title='Chainlink Documentation' link='https://docs.chain.link/' description='A really well-curated series of docs outline how to get started with Chainlink and the different services and networks available.' type='article'}
::resource{title='Implementing a Blockchain Oracle on Ethereum' link='https://medium.com/@pedrodc/implementing-a-blockchain-oracle-on-ethereum-cedc7e26b49e' description='A really well-curated series of docs outline how to get started with Chainlink and the different services and networks available.' type='code'}
::resource{title='Provable Things Ethereum Examples' link='https://github.com/provable-things/ethereum-examples/tree/master/solidity' description='A collection of examples from Provable Things, a bit dated but can still provide a source of reference.' type='code'}
::resource{title='A Study of Blockchain Oracles' link='https://arxiv.org/pdf/2004.07140.pdf' description='A technical examination of blockchain oracles referenced in the blockchain oracles Wikipedia page.' type='article'}
